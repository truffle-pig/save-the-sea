...
public class KakaoAPI {
	...
	public String getAccessToken (String authorize_code) {
		...
		try {
			...
			sb.append("&client_id=a3f9cdf6ff350244d4e4e19401521bfd");
	...
	public HashMap<String, Object> getProfile (String access_Token) {
		...
		try {
			...
			int responseCode = conn.getResponseCode();
			System.out.println("responseCode(profile) : " + responseCode);
			...
			String countryISO = element.getAsJsonObject().get("countryISO").getAsString();

			System.out.println("profileImageURL : " +profileImageURL);
			profile.put("nickName", nickname);
			profile.put("profileImageURL", profileImageURL);
			profile.put("countryISO", countryISO);
	...
	//카카오에 저장된 유저 정보 삭제(앱 연결 해제)
		public void kakaoDisconnect(String access_Token) {
